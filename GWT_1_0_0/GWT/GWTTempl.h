...
protected:
  ...
  virtual void OnNotify(LPNMHDR lpnmh, LRESULT *pRes){ *pRes = 0; }
...
/*
  case WM_INITDIALOG:
    {
      TWindow<T> *pDlg = (TWindow<T>*)lParam;
      if (pDlg)
      {
        pDlg->m_hwnd = hwnd;
...
LRESULT TWindow<T>::WndProc(UINT message, WPARAM wParam, LPARAM lParam)
{
  ...
  case WM_MEASUREITEM:
    {
      ...
      for(; hwndChild != NULL; hwndChild = GetWindow(hwndChild, GW_HWNDNEXT))
      {
        ...
        if(nID == wParam){
          ...
          if(pWnd){
            switch(message){
            case WM_COMPAREITEM: pWnd->OnCompareItem((LPCOMPAREITEMSTRUCT)lParam); break;
            case WM_DRAWITEM:    pWnd->OnDrawItem((LPDRAWITEMSTRUCT)lParam);       break;
            case WM_DELETEITEM:  pWnd->OnDeleteItem((LPDELETEITEMSTRUCT)lParam);   break;
            case WM_MEASUREITEM: pWnd->OnMeasureItem((LPMEASUREITEMSTRUCT)lParam); break;
            }
          } // pWnd
  ...
  case WM_MOUSEMOVE:
    {
      ...
      switch(message){
      case WM_LBUTTONDOWN:    OnLButtonDown(x, y, flags);     break;
      case WM_LBUTTONUP:      OnLButtonUp(x, y, flags);       break;
      case WM_LBUTTONDBLCLK:  OnLButtonDblClk(x, y, flags);   break;
      case WM_RBUTTONDOWN:    OnRButtonDown(x, y, flags);     break;
      case WM_RBUTTONUP:      OnRButtonUp(x, y, flags);       break;
      case WM_RBUTTONDBLCLK:  OnRButtonDblClk(x, y, flags);   break;
      case WM_MOUSEMOVE:      OnMouseMove(x, y, flags);       break;
      }
    }
    break;
  ...
  case WM_SETFOCUS:  OnSetFocus((HWND)wParam);  break;
  case WM_KILLFOCUS: OnKillFocus((HWND)wParam); break;

  case WM_SIZE: OnSize((int)LOWORD(lParam), (int)HIWORD(lParam), (UINT)wParam);  break;
  case WM_MOVE: OnMove((int)(short)LOWORD(lParam), (int)(short)HIWORD(lParam));  break;
...
public:
  TAnimate(){}
  LPCTSTR GetClassName(){ return ANIMATE_CLASS; }
...
public:
  TScrollBar(){}
  LPCTSTR GetClassName(){ return TEXT("SCROLLBAR"); }
...
public:
  ...
  LPCTSTR GetClassName() { return WC_COMBOBOXEX; }
...
public:
  ...
  LPCTSTR GetClassName() { return DATETIMEPICK_CLASS; }
...
public:
  ...
  LPCTSTR GetClassName() { return WC_HEADER; }
...
public:
  ...
  LPCTSTR GetClassName() { return WC_IPADDRESS; }
...
public:
  ...
  LPCTSTR GetClassName() { return MONTHCAL_CLASS; }
...
public:
  ...
  LPCTSTR GetClassName() { return WC_LISTVIEW; }
...
public:
  ...
  LPCTSTR GetClassName() { return PROGRESS_CLASS; }
...
public:
  ...
  LPCTSTR GetClassName() { return STATUSCLASSNAME; }
...
public:
  ...
  LPCTSTR GetClassName() { return TOOLBARCLASSNAME; }
...
public:
  ...
  LPCTSTR GetClassName() { return UPDOWN_CLASS; }
...
public:
  ...
  LPCTSTR GetClassName() { return TRACKBAR_CLASS; }
...
public:
  ...
  LPCTSTR GetClassName() { return TOOLTIPS_CLASS; }
...
public:
  ...
  LPCTSTR GetClassName() { return WC_TABCONTROL; }
...
public:
  int             Run();
  TWnd&           GetMainWindow(){ return m_wndMain; }
